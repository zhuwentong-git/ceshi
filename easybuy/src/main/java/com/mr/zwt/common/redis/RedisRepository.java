package com.mr.zwt.common.redis;
...
public class RedisRepository {
    ...
    public boolean setObj(final String key, final Object obj) {
        ...
        return redisTemplate.execute(new RedisCallback<Boolean>() {
            ...
            public Boolean doInRedis(RedisConnection connection) throws DataAccessException {
                ...
                return connection.set(getSerializer().serialize(key), getSerializer().serialize(JsonUtils.toJsonString(obj)));
            }
        });
    }
    ...
    public <T> boolean setList(String key, List<T> list) {
        ...
        return set(key, JsonUtils.toJsonString(list));
    }
